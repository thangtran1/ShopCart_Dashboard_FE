    ...
    `}
                    >
                      ...
                      <div className="absolute -right-[7px] top-0 bottom-0 w-4 flex flex-col justify-around py-1 z-30">
                        {[...Array(5)].map((_, i) => (
                          <div key={i} className="w-3 h-3 bg-card rounded-full" />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col justify-between py-2.5 px-4 relative">
                      ...
                      <div className="pr-14">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-[10px] font-medium ${isUnlimited ? "text-primary" : "text-warning"}`}>
                            • {isUnlimited ? "Vô hạn" : `${voucher.limitPerUser} lượt dùng`}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-dashed pt-2 flex items-center justify-between text-[10px] text-muted-foreground">
                        <div className="flex items-center gap-1">
                          <span>Đơn tối thiểu:  <span className="ml-1 font-bold text-foreground"><PriceFormatter amount={voucher.minOrderAmount} /></span></span>
                        </div>
                        <div className="flex items-center gap-1">
